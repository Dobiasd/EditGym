...
elm-make src/elm/Start.elm src/elm/Levels.elm src/elm/Game.elm src/elm/Highscores.elm src/elm/Contact.elm src/elm/Help.elm src/elm/FAQ.elm --output build/js/Bundle_uncompressed.js
